...
export const COVERS: Record<string, CoverSpec> = {
  ...
  "architecture-of-in-chat-ai-apps": { quip: "Pressed the button. The app still decides." },
  ...
  "skills-vs-prompts-vs-agents": { quip: "Five layers. One slice. Stop climbing." },
  ...
  "what-a-system-prompt-actually-is": { quip: "House rules. Homework's your problem." },
