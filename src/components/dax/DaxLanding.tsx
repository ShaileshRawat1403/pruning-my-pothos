...
const EVIDENCE = [
  {
    src: "/dax/start-here-01-home.png",
    alt: "DAX home — start-here-01-home",
    caption: "start-here-01-home.png",
  },
  {
    src: "/dax/non-dev-02-rao-approval.png",
    alt: "RAO approval — non-dev-02-rao-approval",
    caption: "non-dev-02-rao-approval.png",
  },
  {
    src: "/dax/non-dev-03-diff-before-approval.png",
    alt: "Diff before approval — non-dev-03-diff-before-approval",
    caption: "non-dev-03-diff-before-approval.png",
  },
] as const;
...
export default function DaxLanding() {
  return (
    <div className="dax-page relative w-full max-w-[1080px] mx-auto">
      {/* Hero — PlateHero rhythm with contract stack visual */}
      <header className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_minmax(260px,340px)] items-center gap-10 lg:gap-14 pt-10 lg:pt-6 pb-14 border-b border-[color:var(--card-border)]">
        <div className="flex flex-col gap-5 lg:pr-4 min-w-0">
          ...
          <h1 className="font-heading text-4xl sm:text-[2.65rem] font-black tracking-tight leading-[1.12] text-[color:var(--text-primary)] max-w-[17.5ch]">
            Deterministic runtime contract or agent harness around stochastic model execution
          </h1>
          <p className="text-base sm:text-lg leading-relaxed max-w-[40ch] text-[color:var(--text-secondary)]">
            DAX is the governed execution workstation: policy, approvals, replay, and audit around the model.
          </p>
      ...
      <section id="outcomes" className="animate-on-scroll">
        ...
        <p className="dax-section-lede">
          Govern mutation, observe the trail, and leave evidence—without turning the agent into a chat log you have to excavate later.
        </p>
      ...
      <section id="tour" className="animate-on-scroll !border-b border-[color:var(--card-border)]">
        ...
        <p className="dax-section-lede">
          A scripted walkthrough of how DAX pauses risky writes, records a verification receipt, and branches on approve or deny. Client-side only—no server.
        </p>
        <RaoTour />
      </section>
      ...
      <section id="contrast" className="animate-on-scroll">
        ...
        <p className="dax-section-lede">
          Same class of tools—different posture on pause, evidence, and replay. Peer tone, not a dunk.
        </p>
      ...
      <section id="evidence" className="animate-on-scroll">
        ...
        <p className="dax-section-lede">
          Framed captures from the product surface—home, RAO approval, and diff before approval.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {EVIDENCE.map((e) => (
            <figure
