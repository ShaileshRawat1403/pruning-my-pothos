...
This article is for builders, operators, and product teams designing agentic user interfaces who need to move beyond plain conversational text replies. Real-world interface implementations and prototypes are cataloged in our [Portfolio](/portfolio/).
...
<nav class="toc" aria-label="On-page">
  ...
  <div class="toc-groups">
    <details open>
      ...
      <ol>
        <li><a href="#why-can-a-text-reply-not-carry-a-workflow">Why can a text reply not carry a workflow?</a></li>
...
### Why can a text reply not carry a workflow?
