...
related:
  ...
  - type: explainer
    ...
    note: "What the reusable layer above a prompt actually is."
  - type: tool
    title: "Prompt to JSON"
    href: /tools/prompt-to-json/
    note: "Compile a loose instruction into a typed schema."
faq:
