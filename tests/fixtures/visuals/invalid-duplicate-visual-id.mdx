---
schemaVersion: "1.0"
title: "Duplicate Visual ID Test"
...
visuals:
  - id: "duplicate-id"
    ...
    caption: "First visual declaration."
  ...
  - id: "duplicate-id"
    ...
    takeaway: "Layer hierarchy showing policy boundary abstraction."
    caption: "Second visual declaration with duplicate ID."
    alt: "Diagram showing host supervisor layered above tool runtime."
    evidenceRole: "explanatory"
    data:
      layers:
        - id: "l1"
