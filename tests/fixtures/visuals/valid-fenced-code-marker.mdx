...
```markdown
Here is documentation illustrating how to use a marker:
<!-- pmp:visual id="marker-inside-fence" -->
```

````markdown
Here is a nested four-backtick block:
```
<!-- pmp:visual id="nested-marker-inside-fence" -->
```
````

And here is the active visual placement:

<!-- pmp:visual id="active-visual" -->
